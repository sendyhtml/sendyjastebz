...
<div id="postLocker" oncontextmenu="return false">
  <div class="lockerContainer" id="postLock">
    ...
    <div class="lockerDescription">CRATE JASTEB</div>
    <input id="lockerPassword" type="text" placeholder="MASUK IN PW MEK." onkeydown="if(event.keyCode==13)postLock()"/>
    <div class="lockerButton" onclick="postLock()"><i class="mainIcon lockIcon"></i>LOGIN</div>
    <div class="lockerOut">
      <a href="https://api.whatsapp.com/send?phone=+6289509551861&text=Assalamualaikum+lukynesia+saya+Mau+join+reseller+jasteb+70k" title="Homepage">BELI CRATE JASTEB</a>
    </div>
  </div>
</div>
...
@media (max-width: 550px) {
  ...
  <body>
    ...
    <div class="nav">
        <img class="logo" src="https://telegra.ph/file/a921901397c373e03bf85.jpg">
        <div class="fill" onclick="window.location.href='https://wa.me/6285792116902;">WhastsApp</div>
        <div class="fill" onclick="window.location.href='/;">Website</div>
    </div>


    <h1>LUKY<strong>GANTENG</strong>PANEL</h1>
    <p class="desc">Create Jasteb by LUKY NESIA Ya</p>
    <p class="desc">Setelah Crate Jasteb Murni Pake Nama Yang Di Berikan Dan Salin Link Apiii.php Segera Send ke Admin LUKY NESIA Agar Bisa Di Konekin Segera!!</p> 

        <div class="check" onclick="window.location='create.php';">CRATE JASTEB MURNI</div>
        <div class="check" onclick="window.location='create2.php';"></div>
       

     
    <span class="copy">
    PANEL JASTEB BY LUKY NESIA
    <div class="rainbow-text" data-splitting></div>
    <div class="rainbow-text animated" data-splitting style="margin-left:5px;">Website : "https://lukynesia.taplink.ws/"</div>
    </span>
    </div>
