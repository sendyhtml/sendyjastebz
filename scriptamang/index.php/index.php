...
<!DOCTYPE html>
	...
	<body>
		<div class="result">
		<div style="background: linear-gradient(-45deg, #ee7752, #e73c7e, #23a6d5, #23d5ab); width: 294; color: #fff; text-align: center; padding: 10px;"> Create by SaaNesia</div>
...
<tr>
				...
				<tr>
					<th style="text-align: center;" colspan="3">YIKK HOST</th>
				</tr>
			</table>
		</div>
	</body>
